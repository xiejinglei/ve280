...
void test_alternating() {
    ...
    assert(MxMoss3::is_alternating(72, 10));
    ...
    assert(MxMoss3::is_alternating(967, 10));
    ...
    assert(MxMoss3::is_alternating(2189, 10));
    ...
    assert(!MxMoss3::is_alternating(3447, 10));
